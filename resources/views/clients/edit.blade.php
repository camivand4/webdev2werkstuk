      ...
      <form action="{{ route('clients.save') }}" method="post">
        ...
        <div class="medium-4  columns">
          ...
          <select name="title">
            ...
            <option value="mw" @if(old('title', ( $client ? $client->title : '') == 'mw') ) selected @endif>Mw.</option>
            <option value="juf" @if(old('title', ( $client ? $client->title : '') == 'juf') ) selected @endif>Juf.</option>
            <option value="dr" @if(old('title', ( $client ? $client->title : '') == 'dr') ) selected @endif>Dr.</option>
          </select>
        </div>
        <div class="medium-4  columns">
